/**
 * This is a bookmarklet that uses components of Typogr to
 * typographically enhance sites. All the actual work is done by
 * functions copied straight from Typogr, so check it out, at:
 *
 * https://github.com/ekalinin/typogr.js
 *
 * The functions were extracted into this bookmarklet to not have to
 * load the two script files (jQuery and Typogr), and because we only
 * need these specific goodies.
 *
...
!(function (window, document) {
  ...
  document.body.innerHTML = smartypants(document.body.innerHTML)
  alert('Dear Sir, I have typogrified. It was a great success.')
}(window, document));